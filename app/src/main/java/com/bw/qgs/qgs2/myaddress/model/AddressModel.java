...
public class AddressModel {
    ...
    public void addre(String url, final HttpAddressCall httpAddressCall){
        OkHttpUtil.executeGet(url, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        httpAddressCall.getAddressBase(s);
                    }
                });
            }
        });
    ...
    public interface HttpAddressCall {
        void getAddressBase(String s);
    }
}
