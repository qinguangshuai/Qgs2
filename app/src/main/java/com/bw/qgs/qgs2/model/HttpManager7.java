 ...
 */
public class HttpManager7 {
    public void getYiFu7(String url,String id,int page,int count, final CallBack callBack){
        RetrofitApi retrofitApi = OkHttpUtil.retrofit.create(RetrofitApi.class);
        Call<String> call = retrofitApi.getYiFu7(url,id,page,count);
